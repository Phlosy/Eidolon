...
export function OfficeEmployee({
  employee,
  selected,
  onSelect,
}: {
  ...
  return (
    <button
      ...
      className={cn(
        "group relative flex min-h-[78px] min-w-0 items-center gap-3 rounded-2xl border bg-background/70 p-3 text-left backdrop-blur transition duration-200 hover:-translate-y-0.5 hover:bg-surface-elevated",
        selected ? "border-border-active shadow-[var(--glow-primary)]" : "border-border",
        meta.hoverClass,
      )}
    >
      <span
      ...
      <span className="min-w-0 flex-1">
        ...
        <span className={cn("type-kicker mt-1.5 block truncate text-[8px]", meta.textClass)}>
