...
| **R1** | PersonCore 拆分（进行中：R1.0 兼容层 ✅、R1.1 人格与学习 ✅、R1.2 知识 owner ✅，R1.3-1.5 待做，方案 docs/person-core-migration.md） | Employee = PersonCore + 所属关系；候选人 = 无所属关系的 PersonCore | E0（事件迁移面） | 概念架构 §2.1 |
